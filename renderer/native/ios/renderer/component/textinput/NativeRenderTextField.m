...
@interface NativeRenderTextField () <NativeRenderUITextFieldResponseDelegate>
@end

@implementation NativeRenderTextField {
...
- (void)observeValueForKeyPath:(NSString *)keyPath
                      ofObject:(__unused NativeRenderTextField *)textField
